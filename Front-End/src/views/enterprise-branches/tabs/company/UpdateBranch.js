...
export default function UpdateBranch() {
    ...
    const getImageUrl = () => {
        let src;
        if (pathname.includes('company')) {
            src = `${api.base_image_path}/companies/branchimages/${branch.branch_image}`;
        } else if (pathname.includes('association')) {
            src = `${api.base_image_path}/associations/branchimages/${branch.branch_image}`;
        } else if (pathname.includes('school')) {
            src = `${api.base_image_path}/schools/branchimages/${branch.branch_image}`;
        }
        return src;
    };
