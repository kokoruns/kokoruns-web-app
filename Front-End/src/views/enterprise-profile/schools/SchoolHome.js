        ...
        <Box className={root}>
            <Grid container>
                ...
                >
                    <Avatar
                        alt="Remy Sharp"
                        src={`${api.base_image_path}${school.cover_image}`}
                        sx={{
                            height: '25vh',
                            position: 'relative',
                            zIndex: '1',
                ...
                <Grid item xs={12} sm={5} md={4} lg={3}>
                            ...
                            >
                                <Box>
                                    <Avatar
                                        ...
                                        alt="Remy Sharp"
                                        src={`${api.base_image_path}${school.logo}`}
                                        sx={{
                                            cursor: 'pointer',
                                            width: 150,
                                            height: 150,
                    ...
                    <SubCard divider={false} p={true} sx={{ marginTop: '30px' }} title="Bio">
                        ...
                        <Box sx={{ display: 'flex', mt: '5px', padding: '5px 10px' }}>
                            ...
                            <Typography sx={{ fontSize: '0.8rem', fontWeight: 'bold', color: '#0991FF', ml: '5px' }}>
                                {school.main_office_location_lga} {school.main_office_location_state}
                            </Typography>
                        </Box>
                        ...
                        <Box sx={{ display: 'flex', mt: '5px', padding: '5px 10px 0px 10px' }}>
                            <Typography sx={{ fontSize: '0.8rem' }}> Number of Students: </Typography>
                            <Typography sx={{ fontSize: '0.8rem', fontWeight: 'bold', color: '#0991FF', ml: '5px' }}>
                                {school.school_size}
                            </Typography>
                        </Box>
