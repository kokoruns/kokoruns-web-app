    ...
    return (
        ...
        >
            <Box className={profile_cover_img}>
                <img alt="bio" src={`${api.base_image_path}${path}`} />
            </Box>
            <Box
                sx={{
...
const PortfolioTab = () => {
    ...
    const { bio, portfolios, social_links } = useSelector((state) => state.authReducer.user);
    ...
    console.log("social_links", social_links, portfolios)
