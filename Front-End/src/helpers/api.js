...
class Api {
    constructor() {
        this.api_token = null;
        this.client = null;
        this.api_url = 'https://kokoruns.com/backend/api';
        this.base_image_path = 'https://kokoruns.com/backend/public/';
        // this.base_image_path = "https://kokoruns.s3.eu-west-3.amazonaws.com";
    ...
    fetchUserDetails = (userId) => {
        return this.init().get(`/userprofile/${userId}`);
    };
    //set up profile
    setUpProfile = (data) => {
